...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Skillfolio Developer</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Skillfolio Developer</h1>
			<!-- Icon Divider-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Welcome to my portfolio website, meticulously crafted to showcase my journey in software development and highlight the progression of my skills.
Utilizing HTML, CSS, and JavaScript for the frontend, and MySQL for the backend database, I meticulously designed and developed this portfolio website. This project serves as a testament to my proficiency in both frontend and backend technologies.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">The website features a secure login system where users can log in with their credentials, with the login data securely stored in the MySQL database on the backend. This ensures not only functionality but also the utmost security of user information.
I invite you to explore my portfolio website to witness firsthand the culmination of my skills and expertise in software development. Feel free to reach out with any inquiries or opportunities for collaboration. Thank you for visiting!</p>
				</div>
			</div>
